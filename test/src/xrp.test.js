...
import { getTransport, numberToBigEndianBuffer, swapTestPrivateKey, partnerSerializedNameAndPubKey, DERSignatureOfPartnerNameAndPublicKey, XRPConfig, XRPConfigSignature } from "./common";


export function getSerializedAddressParametersXRP(
    path: string
