...
exports.REPConfigSignature = exports.REPConfig = exports.USDTConfigSignature = exports.USDTConfig = exports.AEConfigSignature = exports.AEConfig = exports.ETHConfigSignature = exports.ETHConfig = exports.XRPConfigSignature = exports.XRPConfig = exports.LTCConfigSignature = exports.LTCConfig = exports.BTCConfigSignature = exports.BTCConfig = exports.DERSignatureOfPartnerNameAndPublicKey = exports.partnerSerializedNameAndPubKey = exports.swapTestPrivateKey = void 0;

var _HttpTransport = _interopRequireDefault(require("@ledgerhq/hw-transport-http/lib/HttpTransport"));

var _TransportNodeHid = _interopRequireDefault(require("@ledgerhq/hw-transport-node-hid/lib/TransportNodeHid"));
...
exports.swapTestPrivateKey = swapTestPrivateKey;
...
exports.partnerSerializedNameAndPubKey = partnerSerializedNameAndPubKey;
const DERSignatureOfPartnerNameAndPublicKey = Buffer.from([0x30, 0x44, 0x2, 0x20, 0x50, 0xC, 0xA, 0xCF, 0x95, 0x82, 0x0, 0x88, 0x4B, 0x23, 0xC6, 0xAE, 0x7F, 0xEE, 0xCB, 0x1, 0x36, 0x6D, 0x62, 0x48, 0xF4, 0xEA, 0xCB, 0x45, 0x2C, 0x60, 0x81, 0xE9, 0x8, 0x36, 0xDC, 0xCC, 0x2, 0x20, 0x7D, 0x78, 0xCB, 0xC9, 0x10, 0x3D, 0x3, 0xAB, 0x2B, 0x64, 0xE1, 0x61, 0x52, 0x4F, 0xB4, 0xF3, 0xCD, 0x9A, 0x88, 0x3F, 0x7F, 0xED, 0xBF, 0x92, 0xCB, 0x48, 0xBF, 0x7A, 0x10, 0x2D, 0x87, 0x30]); // 3 BTC 7 Bitcoin 0

exports.DERSignatureOfPartnerNameAndPublicKey = DERSignatureOfPartnerNameAndPublicKey;
const BTCConfig = Buffer.from([0x3, 0x42, 0x54, 0x43, 0x7, 0x42, 0x69, 0x74, 0x63, 0x6F, 0x69, 0x6E, 0x0]);
exports.BTCConfig = BTCConfig;
...
exports.AEConfigSignature = AEConfigSignature;
...
exports.REPConfigSignature = REPConfigSignature;

async function getTransport() {
  let transport;

  if (process.env.HID) {
    transport = await _TransportNodeHid.default.open();
  } else {
    transport = await _HttpTransport.default.open("http://127.0.0.1:9998");
  }
